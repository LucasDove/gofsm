...
type EventProcessor interface {
	...
	OnTryExit(fromState string, args []interface{})
	...
	// OnExit Action handles when call Action failed
	OnFail(fromState string, args []interface{})
}
